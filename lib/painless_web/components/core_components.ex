defmodule PainlessWeb.CoreComponents do
  @moduledoc """
  ...
  """
  attr :id, :string, required: true
  attr :table_class, :string, default: "sm:w-full"
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PainlessWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PainlessWeb.Gettext, "errors", msg, opts)
    end
  end
